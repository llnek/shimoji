...
(function(global,undefined){
  ...
  const MojoH5=function(cmdArg) {
    ...
    function _loadFiles(Mojo) {
      let filesToLoad = _.map(Mojo.o.assetFiles || [], f => {
        return Mojo.assetPath(f);
      });
      let ffiles = _.findFiles(filesToLoad, FONT_EXTS);
      ffiles.forEach(s => {
        let span,
          newStyle = dom.newElm("style"),
    ...
    function _prologue(Mojo,arena) {
      ...
      Object.defineProperties(Mojo.canvas, {
        "halfWidth": {
          ...
          get() { return Mojo.canvas.width / 2 } },
        "halfHeight": {
          enumerable: true, configurable: true,
     ...
     */
    let Mojo= {
      TOP: 100, DOWN: 200, RIGHT: 300, LEFT: 400,
